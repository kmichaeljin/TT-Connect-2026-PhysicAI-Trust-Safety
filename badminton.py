...
# 🚨 LIVE BADMINTON CLUES 🚨
CLUE_VAULT = {
    "🥇 GOLD": f"{CB}accomplish separate our When the we inherently actions. talents, than of diverse pool more mere we sum our{CB}",
    "🥈 SILVER": f"{CB}neWh ew lopo uor vedisre nttesal, ew rtlyeehinn aoccilmsph orme nath eht eerm ums fo uro prtaasee coitnas.{CB}",
    "🥉 BRONZE": f"{CB}W_ _n | w_  | p_ _l | o _ r | d _ _ _ _ _ e | t _ _ _ _ _ s, | w_ | i _ _ _ _ _ _ _ _ y | a _ _ _ _ _ _ _ _ h | m _ _ e | t _ _ n | t_e | m _ _ e |  s_m |  _f  | o_r  | s_ _ _ _ _ _e | a_ _ _ _ _s .\n\nThe | acts as a space, when decoding, make sure to remove the |{CB}",
    "🪵 WOOD": f"{CB}• Length: 18 words\n• Punctuation: Comma after the 6th word. Period at the end.\n• Meaning: Combining different talents leads to greater results than acting separately.\n• Wording clues: Includes the exact phrases “diverse talents” and “mere sum.”\n• Structure clue: The sentence contrasts collective achievement with separate actions.{CB}"
}
    ...
    for tier, team in placements.items():
        ...
        if channel_id and channel_id.startswith("C"):  
            try:
                ...
                message = (
                    f"Congratulations on finishing Quest 2: Badminton! Your team placed: {tier}\n\n"
