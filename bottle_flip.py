...
# UNIQUE TOURNAMENT NAME FOR GOOGLE SHEETS
TOURNAMENT_NAME = "QUEST 4: BOTTLE FLIP TIC TAC TOE"
...
# 🚨 LIVE BOTTLE FLIP CLUES 🚨
CLUE_VAULT = {
    "🥇 GOLD": f"{CB}spots strategies chaos. align protect each other's during blind We must the continuously our and{CB}",
    "🥈 SILVER": f"{CB}eW tmsu snuoyitouncl gnial uro rteegstais dan trtocep aceh eo'rhts lidbn sspot udngir eht shoac.{CB}",
    "🥉 BRONZE": f"{CB}W_ | m _ _ t | c _ _ _ _ _ _ _ _ _ y | a _ _ _ n | o _ r | s _ _ _ _ _ _ _ s | a _ d | p _ _ _ _ _ t | e _ _ h | o _ _ _ r ' s | b _ _ _ d | s _ _ _ s | d _ _ _ _ g | t _ e | c _ _ _ s .\n\nThe | acts as a space, when decoding, make sure to remove the |{CB}",
    "🪵 WOOD": f"{CB}• Length: 14 words\n• Punctuation: Period at the end.\n• Meaning: In disorder, constant coordination and mutual protection are necessary.\n• Wording clues: Includes the exact phrases “continuously align” and “blind spots.”\n• Structure clue: The sentence has two parallel actions joined by “and.”{CB}"
}
    ...
    for tier, team in placements.items():
        ...
        if channel_id and channel_id.startswith("C"):  
            try:
                ...
                message = (
                    f"Congratulations on finishing Quest 4: Bottle Flip Tic Tac Toe! Your team placed: {tier}\n\n"
